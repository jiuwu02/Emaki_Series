...
public final class LanguageLoader {
    ...
    private final String fallbackLanguage = "zh_CN";

    public LanguageLoader(EmakiStrengthenPlugin plugin) {
        this.plugin = plugin;
    ...
    private Object getNestedValue(String language, String dottedPath) {
        ...
        return current != null ? current : configuration.getValues(false).get(dottedPath);
    }
}

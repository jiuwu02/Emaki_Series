...
registerModuleLocale(MODULE, 'zh-CN', {
  ...
  'emakiitem.editor.item.title': 'EmakiItem 物品定义',
  'emakiitem.editor.set.title': 'EmakiItem 套装定义',
...
registerModuleLocale(MODULE, 'en-US', {
  ...
  'emakiitem.editor.item.title': 'EmakiItem Item Definition',
  'emakiitem.editor.set.title': 'EmakiItem Set Definition',

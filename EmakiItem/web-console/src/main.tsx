...
registerModuleLocale(MODULE, 'zh-CN', {
  ...
  'emakiitem.file.items.comment': 'EmakiItem 自定义物品文件。',
  'emakiitem.file.sets.title': '套装',
  'emakiitem.file.sets.comment': 'EmakiItem 套装文件。',
  'emakiitem.filePath.items_example_item.title': '示例物品',
  'emakiitem.filePath.items_example_item.comment': '示例物品文件。',
  'emakiitem.filePath.sets_example_set.title': '示例套装',
  'emakiitem.filePath.sets_example_set.comment': '示例套装文件。',
  ...
  'emakiitem.file.web-console.comment': 'Web Console 文件注册与资源入口声明。',
...
registerModuleLocale(MODULE, 'en-US', {
  ...
  'emakiitem.file.items.comment': 'Custom item files for EmakiItem.',
  'emakiitem.file.sets.title': 'Sets',
  'emakiitem.file.sets.comment': 'EmakiItem set files.',
  'emakiitem.filePath.items_example_item.title': 'Sample Item',
  'emakiitem.filePath.items_example_item.comment': 'Sample item file.',
  'emakiitem.filePath.sets_example_set.title': 'Sample Set',
  'emakiitem.filePath.sets_example_set.comment': 'Sample set file.',
  ...
  'emakiitem.file.web-console.comment': 'Web Console file registration and resource entry declaration.',
...
function ItemEffectList({ value, onChange, actionTypesResult, path }: { value: unknown; onChange: (value: unknown[]) => void; actionTypesResult: ItemFieldRendererContext['actionTypesResult']; path?: string }) {
  ...
  const add = (type: string) => onChange([...effects, defaultItemEffect(type)]);
  return <div className="prop-levels" role="list">
...
function ItemEffectPayload({ effect, type, path, onChange, actionTypesResult }: { effect: AnyMap; type: string; path?: string; onChange: (value: AnyMap) => void; actionTypesResult: ItemFieldRendererContext['actionTypesResult'] }) {
  ...
  return <ItemMapRow label="fields" path={path} value={payload} onChange={fields => onChange(cleanObject({ type, ...fields }))} />;
}

function defaultItemEffect(type: string): AnyMap {
...
function ItemSelectInput({ value, options, onChange }: { value: unknown; options: string[]; onChange: (value: string) => void }) {
  const current = textValue(value);

...
const localeMessages: Record<string, string> = Object.fromEntries([
  ...
  ['emakiforge.filePath.recipes_example_recipe.comment', '示例配方文件。'],
  ['emakiforge.filePath.gui_editor_gui.title', '编辑器 GUI'],
  ['emakiforge.filePath.gui_editor_gui.comment', '编辑器 GUI 模板文件。'],
  ['emakiforge.filePath.gui_forge_gui.title', '锻造 GUI'],
...
registerModuleLocale(MODULE, 'en-US', {
  ...
  'emakiforge.filePath.recipes_example_recipe.comment': 'Sample recipe file.',
  'emakiforge.filePath.gui_editor_gui.title': 'Editor GUI',
  'emakiforge.filePath.gui_editor_gui.comment': 'Editor GUI template file.',
  'emakiforge.filePath.gui_forge_gui.title': 'Forge GUI',

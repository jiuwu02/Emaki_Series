...
const localeMessages: Record<string, string> = Object.fromEntries([
  ...
  ['emakicooking.filePath.recipes_chopping_board_example_recipe.comment', '砧板配方文件。'],
  ['emakicooking.filePath.recipes_fermentation_barrel_example_recipe.title', '发酵桶配方 · example recipe'],
  ['emakicooking.filePath.recipes_fermentation_barrel_example_recipe.comment', '发酵桶配方文件。'],
  ['emakicooking.filePath.recipes_grinder_example_recipe.title', '研磨机配方 · example recipe'],
  ['emakicooking.filePath.recipes_grinder_example_recipe.comment', '研磨机配方文件。'],
  ['emakicooking.filePath.recipes_juicer_example_recipe.title', '榨汁机配方 · example recipe'],
  ['emakicooking.filePath.recipes_juicer_example_recipe.comment', '榨汁机配方文件。'],
  ['emakicooking.filePath.recipes_oven_example_recipe.title', '烤炉配方 · example recipe'],
  ['emakicooking.filePath.recipes_oven_example_recipe.comment', '烤炉配方文件。'],
  ['emakicooking.filePath.recipes_steamer_chain_example_recipe.title', '蒸锅配方 · chain example recipe'],
  ['emakicooking.filePath.recipes_steamer_chain_example_recipe.comment', '蒸锅配方文件。'],
  ['emakicooking.filePath.recipes_steamer_example_recipe.title', '蒸锅配方 · example recipe'],
  ['emakicooking.filePath.recipes_steamer_example_recipe.comment', '蒸锅配方文件。'],
  ['emakicooking.filePath.recipes_wok_example_recipe.title', '炒锅配方 · example recipe'],
  ['emakicooking.filePath.recipes_wok_example_recipe.comment', '炒锅配方文件。'],
  ['emakicooking.filePath.gui_fermentation_barrel.title', '发酵桶 GUI'],
  ['emakicooking.filePath.gui_fermentation_barrel.comment', '发酵桶 GUI 模板文件。'],
  ['emakicooking.filePath.gui_juicer.title', '榨汁机 GUI'],
  ['emakicooking.filePath.gui_juicer.comment', '榨汁机 GUI 模板文件。'],
  ['emakicooking.filePath.gui_oven.title', '烤炉 GUI'],
...
registerModuleLocale(MODULE, 'en-US', {
  ...
  'emakicooking.filePath.recipes_chopping_board_example_recipe.comment': 'Chopping board recipe file.',
  'emakicooking.filePath.recipes_fermentation_barrel_example_recipe.title': 'Fermentation Barrel Recipe · example recipe',
  'emakicooking.filePath.recipes_fermentation_barrel_example_recipe.comment': 'Fermentation barrel recipe file.',
  'emakicooking.filePath.recipes_grinder_example_recipe.title': 'Grinder Recipe · example recipe',
  'emakicooking.filePath.recipes_grinder_example_recipe.comment': 'Grinder recipe file.',
  'emakicooking.filePath.recipes_juicer_example_recipe.title': 'Juicer Recipe · example recipe',
  'emakicooking.filePath.recipes_juicer_example_recipe.comment': 'Juicer recipe file.',
  'emakicooking.filePath.recipes_oven_example_recipe.title': 'Oven Recipe · example recipe',
  'emakicooking.filePath.recipes_oven_example_recipe.comment': 'Oven recipe file.',
  'emakicooking.filePath.recipes_steamer_chain_example_recipe.title': 'Steamer Recipe · chain example recipe',
  'emakicooking.filePath.recipes_steamer_chain_example_recipe.comment': 'Steamer recipe file.',
  'emakicooking.filePath.recipes_steamer_example_recipe.title': 'Steamer Recipe · example recipe',
  'emakicooking.filePath.recipes_steamer_example_recipe.comment': 'Steamer recipe file.',
  'emakicooking.filePath.recipes_wok_example_recipe.title': 'Wok Recipe · example recipe',
  'emakicooking.filePath.recipes_wok_example_recipe.comment': 'Wok recipe file.',
  'emakicooking.filePath.gui_fermentation_barrel.title': 'Fermentation Barrel GUI',
  'emakicooking.filePath.gui_fermentation_barrel.comment': 'Fermentation barrel GUI template file.',
  'emakicooking.filePath.gui_juicer.title': 'Juicer GUI',
  'emakicooking.filePath.gui_juicer.comment': 'Juicer GUI template file.',
  'emakicooking.filePath.gui_oven.title': 'Oven GUI',

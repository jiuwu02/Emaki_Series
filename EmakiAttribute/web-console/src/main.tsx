...
registerModuleLocale(MODULE, 'zh-CN', {
  ...
  'emakiattribute.filePath.conditions_default_bind.comment': '默认绑定条件文件。',
  'emakiattribute.filePath.conditions_default_equipment_level.title': '默认装备等级条件',
  'emakiattribute.filePath.conditions_default_equipment_level.comment': '默认装备等级条件文件。',
  'emakiattribute.filePath.conditions_emakiitem.title': 'EmakiItem 条件',
  'emakiattribute.filePath.conditions_emakiitem.comment': 'EmakiItem 条件文件。',
  'emakiattribute.filePath.conditions_forge.title': '锻造条件',
  'emakiattribute.filePath.conditions_forge.comment': '锻造条件文件。',
  'emakiattribute.filePath.conditions_strengthen.title': '强化条件',
  'emakiattribute.filePath.conditions_strengthen.comment': '强化条件文件。',
...
registerModuleLocale(MODULE, 'en-US', {
  ...
  'emakiattribute.filePath.conditions_default_bind.comment': 'Default bind condition file.',
  'emakiattribute.filePath.conditions_default_equipment_level.title': 'Default Equipment Level Condition',
  'emakiattribute.filePath.conditions_default_equipment_level.comment': 'Default equipment level condition file.',
  'emakiattribute.filePath.conditions_emakiitem.title': 'EmakiItem Condition',
  'emakiattribute.filePath.conditions_emakiitem.comment': 'EmakiItem condition file.',
  'emakiattribute.filePath.conditions_forge.title': 'Forge Condition',
  'emakiattribute.filePath.conditions_forge.comment': 'Forge condition file.',
  'emakiattribute.filePath.conditions_strengthen.title': 'Strengthen Condition',
  'emakiattribute.filePath.conditions_strengthen.comment': 'Strengthen condition file.',

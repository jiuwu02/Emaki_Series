...
public record AttributeConfig(String language,
    ...
    public static AttributeConfig defaults() {
        return new AttributeConfig("zh_CN", true, "physical", 20, 1, List.of());
    }
    ...
    public static AttributeConfig fromConfig(YamlConfiguration configuration) {
        ...
        return new AttributeConfig(language, hardLockDamage, defaultDamageType, regenIntervalTicks, syncDelayTicks, List.copyOf(causes));
    }

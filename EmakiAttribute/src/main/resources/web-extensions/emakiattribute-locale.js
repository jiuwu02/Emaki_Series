(function(e,t){var n=`.ea-diagnostics {\r
  --text-primary: var(--text);\r
  --text-secondary: var(--muted);\r
  --border-subtle: var(--line);\r
  --surface-card: var(--surface);\r
  --surface-input: var(--input);\r
  --surface-muted: var(--surface-2);\r
  --surface-raised: var(--surface);\r
  display: grid;\r
  gap: 14px;\r
  padding: 14px 18px 28px;\r
  color: var(--text);\r
}\r
\r
.ea-diagnostics__grid {\r
  display: grid;\r
  grid-template-columns: minmax(280px, 360px) minmax(0, 1fr);\r
  gap: 14px;\r
  align-items: start;\r
}\r
\r
...
\r
.ea-form input {\r
  min-height: var(--config-field-control-height, 30px);\r
  border-radius: 6px;\r
  border: 1px solid var(--line);\r
...
\r
.ea-form input:focus {\r
  border-color: var(--line-2);\r
}\r
\r
.ea-form input:focus-visible {\r
...
\r
.ea-table tr:last-child th,\r
.ea-table tr:last-child td {\r
  border-bottom: 0;\r
}\r
\r
.ea-muted {\r

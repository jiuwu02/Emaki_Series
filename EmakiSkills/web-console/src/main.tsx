...
const localeMessages: Record<string, string> = Object.fromEntries([
  ...
  ['emakiskills.file.skills.comment', '技能文件目录。'],
  ['emakiskills.file.resources.title', '资源'],
  ['emakiskills.file.resources.comment', '技能资源文件目录。'],
  ['emakiskills.filePath.skills_example_skill.title', '示例技能'],
  ['emakiskills.filePath.skills_example_skill.comment', '示例技能文件。'],
  ['emakiskills.filePath.skills_example_combo_skill.title', '连击示例技能'],
  ['emakiskills.filePath.skills_example_combo_skill.comment', '连击示例技能文件。'],
  ['emakiskills.filePath.skills_example_projectile_skill.title', '投射物示例技能'],
  ['emakiskills.filePath.skills_example_projectile_skill.comment', '投射物示例技能文件。'],
  ['emakiskills.filePath.resources_example_resource.title', '示例资源'],
  ['emakiskills.filePath.resources_example_resource.comment', '示例资源文件。'],
...
registerModuleLocale(MODULE, 'en-US', {
  ...
  'emakiskills.file.skills.comment': 'Directory for skill files.',
  ...
  'emakiskills.filePath.skills_example_skill.comment': 'Sample skill file.',
  'emakiskills.filePath.skills_example_combo_skill.title': 'Sample Combo Skill',
  'emakiskills.filePath.skills_example_combo_skill.comment': 'Sample combo skill file.',
  'emakiskills.filePath.skills_example_projectile_skill.title': 'Sample Projectile Skill',
  'emakiskills.filePath.skills_example_projectile_skill.comment': 'Sample projectile skill file.',
  'emakiskills.filePath.resources_example_resource.title': 'Sample Resource',
  'emakiskills.filePath.resources_example_resource.comment': 'Sample resource file.',

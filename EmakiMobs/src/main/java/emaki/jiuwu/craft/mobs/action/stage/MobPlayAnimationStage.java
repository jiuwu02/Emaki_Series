...
public final class MobPlayAnimationStage extends BaseStage {
    ...
    public @NotNull CoreActionOutcome execute(@NotNull CoreStageContext context,
        ...
        if (animation == null || animation.isBlank()) {
            return CoreActionOutcome.failure(CoreActionFailureKind.INVALID_CONFIG,
                    "action.stage.mob_play_animation.missing_animation", Map.of());
        }
        ...
        if (mobId == null) {
            return CoreActionOutcome.skipped("action.stage.mob_play_animation.not_managed");
        }
        modelManager.playNamed(entity, mobId, animation);

...
public final class ActionContext {
    ...
    public static ActionContext create(Plugin sourcePlugin, Player player, String phase, boolean silent, boolean debug) {
        return new ActionContext(sourcePlugin, player, phase, silent, debug, Map.of(), Map.of());
    }
    ...
    public ActionContext withPhase(String value) {
        return new ActionContext(sourcePlugin, player, value, silent, debug, placeholders, attributes);
    }
    ...
    public ActionContext withPlaceholder(String key, Object value) {
        ...
        return new ActionContext(sourcePlugin, player, phase, silent, debug, copy, attributes);
    }
    ...
    public ActionContext withAttribute(String key, Object value) {
        ...
        copy.put(key, value);
        return new ActionContext(sourcePlugin, player, phase, silent, debug, placeholders, copy);
    }

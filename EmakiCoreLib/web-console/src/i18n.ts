...
const CORE_ZH_CN: LocaleMessages = {
  ...
  'core.theme.dark': '深色',
  'core.theme.light': '浅色',
  'emakicorelib.module.name': '绘卷核心库',
  'emakicorelib.module.summary': 'Web Console、Action、脚本与公共运行库',
  ...
  'emakicorelib.field.web_console': 'Web Console',
  'emakicorelib.comment.web_console': '内置前端控制台开放策略与鉴权配置。',
  ...
  'emakicorelib.comment.web_console.port': 'Web Console HTTP 端口。',
  ...
  'emakicorelib.comment.web_console.auth': 'Web Console 登录账号、密码和会话有效期。',
  'emakicorelib.field.web_console.auth.username': '账号',
  'emakicorelib.comment.web_console.auth.username': 'Web Console 登录账号。',
  'emakicorelib.field.web_console.auth.password': '密码',
  'emakicorelib.comment.web_console.auth.password': 'Web Console 登录密码，启用前必须修改默认值。',
  ...
  'emakicorelib.comment.web_console.security': 'Web Console 请求体、写入权限等安全限制。',
  'emakicorelib.field.web_console.security.allow_config_write': '允许写配置',
  'emakicorelib.comment.web_console.security.allow_config_write': '开启后 Web Console 才允许保存配置变更。',
  'emakicorelib.field.web_console.security.max_request_body_kb': '请求体上限',
  'emakicorelib.comment.web_console.security.max_request_body_kb': '单次 Web 请求体大小上限，单位 KB。',
  'emakicorelib.field.action': 'Action',
  ...
  'emakicorelib.field.script': 'CoreLib JS',
  ...
  'core.brand.console': 'Web Console',
  'core.brand.sigil': '绘',
  ...
  'core.empty.noRegistry': '没有读取到已注册模块。确认 Emaki 插件已启动并注册 Web Console 后重试。',
  ...
  'core.file.deleteDesc': '将删除 {path}。此操作无法在 Web Console 内撤销，请输入完整路径确认。',
  ...
  'core.login.description': '用于管理员团队集中编辑 Emaki 系列插件配置。保存后执行插件 reload 使运行时生效。',

...
const CORE_ZH_CN: LocaleMessages = {
  ...
  'core.option.effect.ea_attribute': 'Mythic 属性',
  'core.option.effect.es_skill': 'Mythic 技能',
  ...
  'core.gui.gridHelp': '方向键移动槽位，Enter 或空格选择，按住 Shift 可追加选择。',
  ...
  'core.editor.reloadDesc': '当前文件已被修改但尚未保存。继续重载会从服务器重新读取文件，并丢弃本地草稿。',
  ...
  'core.i18n.open': '语言文本',
  'core.i18n.openAria': '查看 {module} 的语言文本',
  'core.i18n.title': '语言文本',

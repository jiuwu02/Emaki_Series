...
export const CORE_ITEM_FIELD_TYPES = ['text', 'number', 'boolean', 'enum', 'multiEnum', 'material', 'textarea', 'stringList', 'numberList', 'map', 'dynamicMap', 'objectMap', 'variablesMap', 'json', 'actions', 'economyProvider'] as const;

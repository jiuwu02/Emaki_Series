...
public final class YamlConfigLoader<T> {
    ...
    public YamlConfigLoader(JavaPlugin plugin,
        ...
        this(plugin, relativePath, relativePath, defaultsSupplier, parser, "console.loader_config_load_error");
    }
    ...
    public T load() {
        try {
            File file = file();
            VersionedYamlFile versionedFile = YamlFiles.loadCurrentResource(plugin, file, resourcePath);
            YamlSection configuration = versionedFile == null ? null : versionedFile.root();

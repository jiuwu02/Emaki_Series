...
public final class BuiltinActions {
    ...
    public static void registerAll(ActionRegistry registry,
        ...
        registry.register(new BossBarHideAction());
        ...
        registry.register(new GiveItemAction(itemSourceService));
        registry.register(new SetItemAction(itemSourceService));
        registry.register(new ClearItemAction(itemSourceService));
        registry.register(new TakeItemAction(itemSourceService));
        registry.register(new DropItemAction(itemSourceService));
        registry.register(new PlaceBlockAction(itemSourceService, craftEngineBlockBridge, itemsAdderBlockBridge, nexoBlockBridge, oraxenBlockBridge));
        registry.register(new SetBlockAction());
        registry.register(new BreakBlockAction());
        registry.register(new TeleportAction());
        registry.register(new SpawnEntityAction());
        registry.register(new KillEntityAction());
        registry.register(new ExplosionAction());
        registry.register(new HealAction());
        registry.register(new DamageAction());
        registry.register(new FeedAction());
        registry.register(new IgniteAction());
        registry.register(new ExtinguishAction());
        registry.register(new SetHealthAction());
        registry.register(new RepairItemAction());
        registry.register(new DamageItemAction());

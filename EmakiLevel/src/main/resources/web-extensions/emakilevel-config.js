...
\r
.level-curve-preview__header,\r
.level-curve-preview__summary,\r
.level-curve-preview__legend,\r
.level-curve-preview__inspector-head,\r
.level-curve-preview__tooltip-title {\r
  display: flex;\r
  gap: 8px;\r
}\r
\r
...
\r
.level-curve-preview__hint,\r
.level-curve-preview__empty,\r
.level-curve-preview__inspector-empty {\r
  margin: 4px 0 0;\r
  color: var(--muted);\r
  font-size: 12px;\r
  line-height: 1.45;\r
...
\r
.level-curve-preview__controls {\r
  display: grid;\r
  grid-template-columns: minmax(220px, 2fr) repeat(3, minmax(120px, 1fr));\r
  gap: 10px;\r
}\r
\r
.level-curve-preview__field {\r
  display: grid;\r
  gap: 5px;\r
  color: var(--muted);\r
  font-size: 12px;\r
...
\r
.level-curve-preview__field input,\r
.level-curve-preview__field select {\r
  min-height: 32px;\r
  color: var(--text);\r
...
\r
.level-curve-preview__field input:focus-visible,\r
.level-curve-preview__field select:focus-visible,\r
.level-curve-preview__legend-button:focus-visible,\r
.level-curve-preview__table-head:focus-visible {\r
...
\r
.level-curve-preview__legend-button {\r
  min-height: 30px;\r
  ...
  padding: 4px 8px;\r
  color: var(--text);\r
  background: color-mix(in oklch, var(--surface-2) 78%, transparent);\r
  border: 1px solid var(--line);\r
...
\r
.level-curve-preview__legend-button[aria-pressed="false"] {\r
  opacity: .48;\r
}\r
\r
.level-curve-preview__swatch {\r
  width: 10px;\r
  height: 10px;\r
  border-radius: 999px;\r
  flex: 0 0 auto;\r
  background: var(--curve-color, var(--accent));\r
}\r
\r
.level-curve-preview__chart-wrap {\r
  overflow-x: auto;\r
}\r
\r
.level-curve-preview__chart {\r
  display: block;\r
  width: 100%;\r
  min-width: 720px;\r
  background: var(--input);\r
...
\r
.level-curve-preview__summary strong {\r
  color: var(--text);\r
}\r
\r
.level-curve-preview__inspector,\r
.level-curve-preview__inspector-empty {\r
  padding: 10px;\r
  border: 1px solid var(--line-2);\r
  border-radius: 8px;\r
  background: color-mix(in oklch, var(--surface-2) 70%, transparent);\r
}\r
\r
.level-curve-preview__inspector-head {\r
  justify-content: space-between;\r
...
\r
.level-curve-preview__inspector-rows {\r
  max-height: 220px;\r
  overflow-y: auto;\r
  display: grid;\r
  gap: 8px;\r
...
\r
.level-curve-preview__tooltip-row {\r
  display: grid;\r
  grid-template-columns: 10px minmax(0, 1fr);\r
  gap: 8px;\r
  align-items: start;\r
}\r
\r
.level-curve-preview__tooltip-copy {\r
  min-width: 0;\r
}\r
\r
.level-curve-preview__tooltip-title {\r
...
\r
.level-curve-preview__tooltip-meta {\r
  margin-top: 3px;\r
  display: grid;\r
...
\r
.level-curve-preview__tooltip-number {\r
  display: block;\r
  margin-top: 1px;\r
...
\r
.level-curve-preview__tables {\r
  display: grid;\r
  gap: 8px;\r
}\r
\r
.level-curve-preview__table-group {\r
  border: 1px solid var(--line);\r
  border-radius: 8px;\r
  overflow: hidden;\r
  background: color-mix(in oklch, var(--surface-2) 54%, transparent);\r
}\r
\r
.level-curve-preview__table-group[aria-disabled="true"] {\r
  opacity: .5;\r
}\r
\r
.level-curve-preview__table-head {\r
  width: 100%;\r
  min-height: 36px;\r
  display: grid;\r
  grid-template-columns: 18px 10px minmax(120px, 1fr) minmax(80px, .6fr) auto auto;\r
  align-items: center;\r
...
\r
.level-curve-preview__warning-pill {\r
  color: var(--amber);\r
  border: 1px solid color-mix(in oklch, var(--amber) 44%, var(--line) 56%);\r
  border-radius: 999px;\r
  padding: 1px 6px;\r
}\r
\r
.level-curve-preview__table-scroll {\r
  overflow-x: auto;\r
}\r
\r
.level-curve-preview__table {\r
  width: 100%;\r
  min-width: 720px;\r
...
\r
.level-curve-preview__table th,\r
.level-curve-preview__table td {\r
  padding: 7px 10px;\r
  border-bottom: 1px solid color-mix(in oklch, var(--line) 72%, transparent);\r
...
\r
.level-curve-preview__col-lv {\r
  width: 64px;\r
}\r
\r
.level-curve-preview__col-required {\r
  width: 120px;\r
}\r
\r
.level-curve-preview__col-total {\r
  width: 130px;\r
}\r
\r
.level-curve-preview__col-growth {\r
  width: 100px;\r
}\r
\r
.level-curve-preview__col-warnings {\r
  width: 120px;\r
}\r
\r
.level-curve-preview__num {\r
  font-variant-numeric: tabular-nums;\r
}\r
\r
.level-curve-preview__source {\r
  display: block;\r
  overflow: hidden;\r
  text-overflow: ellipsis;\r
  white-space: nowrap;\r
  color: var(--subtle-readable);\r
}\r
\r
.level-curve-preview__diagnostic {\r
  margin-top: 8px;\r
  color: var(--subtle-readable);\r
  font-size: 11px;\r
}\r
\r
.level-curve-preview__diagnostic pre {\r
  margin: 6px 0 0;\r
  white-space: pre-wrap;\r
}\r
\r
@media (max-width: 920px) {\r
  .level-curve-preview__header,\r
  .level-curve-preview__controls {\r
    display: grid;\r
